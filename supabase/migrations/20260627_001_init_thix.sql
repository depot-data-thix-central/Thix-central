-- Dreamflow migration: THIX baseline schema
-- Includes THIX MARKET + THIX ID users table.
...
-- =============================================================================
-- public.users (app-level profile mapped to Sign Up form)
-- =============================================================================
...
create trigger trg_public_users_updated_at before update on public.users for each row execute function public.set_updated_at();
